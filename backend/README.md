...
## Project Structure
    ...
    ├── testapiautostorybo_112876  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_112876`
...
2. Clone this repo and `cd testapiautostorybo_112876`
